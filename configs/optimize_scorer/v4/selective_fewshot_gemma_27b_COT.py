...
from optimizers.fewshot_optimizer import SelectiveFewShotOptimizer
from functools import partial

NAME = "selective_fewshot_gemma_27b_15_shots_COT"
...
config = Config(
    ...
    optimizer=partial(SelectiveFewShotOptimizer, k=15),
    predict_module=dspy.ChainOfThought
)
